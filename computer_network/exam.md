...
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第432页
...
移动IPv4代理发现机制工作原理如下图所示。移动代理工作周期性地发送代理通告报文，或为响应移动节点的代理请求而发送代理通告报文。移动节点在接收到代理通告报文后，判断它是否从一个网络切换到另一个网络，是在家乡网络还是在外地网络。在切换到外地网络时，可以选择使用外地代理提供的转交地址。

@import "http://cdn.dianhsu.top/img/20210527123813.jpg" {width=500, title="移动IPv4代理发现机制原理示意图" alt="移动IPv4代理发现机制原理示意图"}
...
@import "http://cdn.dianhsu.top/img/20210527130122.jpg" {width=500, title="移动节点在外地网络上接收单播分组" alt="移动节点在外地网络上接收单播分组"}
...
@import "http://cdn.dianhsu.top/img/20210527130258.jpg" {width=500, title="移动节点接收多播数据分组的方法" alt="移动节点接收多播数据分组的方法"}
@import "http://cdn.dianhsu.top/img/20210527130603.jpg" {width=500, title="移动节点发送多播数据分组的方法" alt="移动节点发送多播数据分组的方法"}
...
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第335页
...
### :fire:简述物联网感知层设备的分类
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第605页
...
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第406页
...
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第488页、第493页
...
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第380页、第407页
...
#### 假设路由器接收到一个目的地址为202.115.a.b的IP分组，请确定该路由器为该IP分组选择的下一跳，并解释说明。
 | 第一段 | 第二段 | 第三段   | 第四段    | 下一跳 |
 | ------ | ------ | -------- | --------- | ------ |
 | `202`  | `115`  | `0-63`   | `*`       | D      |
 | ^      | ^      | `64`     | `*`       | A      |
...
#### 在上面的路由器路由表中增加两条路由表项（特定主机路由，默认路由）
...
#### 将202.117.0.0/16划分为4个规模尽可能大的等长子网，请给出子网掩码及每个子网可分配主机地址范围
> 参考：[计算机网络（第七版）](https://item.jd.com/12219883.html) 第139页
...
相同子网可以相互通信，所以可以相互通信的IP地址是202.115.28.112、202.115.28.120和202.115.28.135。

#### 哪些需要通过设置路由器才能通信，请画出网络连接示意图，并注明各个主机的子网地址和主机地址。
...
@import "http://cdn.dianhsu.top/img/20210527142704.jpg" {width=500, title="物联网层次结构模型" alt="物联网层次结构模型"}
...
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第382页

集中式P2P网络与传统C/S模式存在着相同之处，即集中式P2P网络中也存在这中心服务器，但是两者之间有很大的区别。下图表示出集中式P2P网络与传统C/S工作模式的区别。

@import "http://cdn.dianhsu.top/img/20210527150828.jpg" {width=500, title="集中式P2P网络与传统C/S工作方式的区别" alt="集中式P2P网络与传统C/S工作方式的区别"}
...
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第232页
...
> 参考：[计算机网络高级编程（第2版）](https://item.jd.com/11768206.html) 第1页
